...
% tikz
\usepackage{tikz}
\usetikzlibrary{intersections, angles, quotes, positioning,fit,backgrounds}
...
\declaretheorem[style=thmgreen3box, numbered=no, name=Fact]{fact} % my own env
...
% conjecture
% eg (example)
% tmpexplanation (proof)
% remark
% note
% exercise
% prev (As previously seen)
% intuition
% notation
% tmpanswer (Answer)
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead[L]{B12202004 Shao-Kai Jonathan Huang}
% \fancyhead[R]{\@lecture}
\fancyhead[R]{Notes in ODE}
\fancyfoot[L]{}
\fancyfoot[R]{\thepage}
...
% Jonathan's packages
% \usepackage{minted} % minted requires -shell-escape
\usepackage{listings}
